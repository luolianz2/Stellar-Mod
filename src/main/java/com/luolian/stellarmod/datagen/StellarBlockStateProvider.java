...
public class StellarBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {  //添加方块
        ...
        simpleBlock(StellarBlocks.RAINBOW_BLOCK.get(),
                new ModelFile.UncheckedModelFile(modLoc("block/rainbow_block")));
        simpleBlock(StellarBlocks.CRAFTING_AREA_BLOCK.get(),
                new ModelFile.UncheckedModelFile(modLoc("block/crafting_area_block")));
    }
